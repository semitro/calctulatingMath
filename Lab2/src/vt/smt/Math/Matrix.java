...
import vt.smt.GUI.lab1.Observer.*;
import vt.smt.GUI.lab1.Observer.Observer;
import vt.smt.GUI.lab1.Observer.Observable;
...
public class Matrix implements Observable {
    ...
    public void triangulate(){
        ...
        vt.smt.Math.Util.printMatrix(this.get());
        normalize();
        isTriangle = true;
    }
